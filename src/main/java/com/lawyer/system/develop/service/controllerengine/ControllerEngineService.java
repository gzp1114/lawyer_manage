...
public class ControllerEngineService {

	private static Logger logger = LoggerFactory.getLogger(ControllerEngineService.class);
	 ...
	 *            文件或文件夹
	 */
	public void engine(ControllerElementKit controllerElementKit, String destPath,
			String templePath,  String fileName) {
		
		File destFile = new File(destPath);
		analysisEngine( controllerElementKit,destFile, templePath, fileName);
	 ...
	 * @param file
	 */
	private void analysisEngine(ControllerElementKit controllerElementKit,File destFile, String templePath,
			String fileName) {
		...
		try {
			...
			context.put("controllerElementKit", controllerElementKit);
