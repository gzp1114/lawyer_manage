...
public class ControllerElementKit {
	
	public ControllerElementKit(){}
	
	public ControllerElementKit(Table table,String packagePath){
	...
	public String getTemplatePath(){
		...
		return DevelopContents.CONTROLLER_ENGINE_TEMPLATE_PATH;
