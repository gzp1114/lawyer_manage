...
<html>
	...
	<body>
		...
		<div class="cinema_list">
			<form class="form-horizontal" id="sysRoleModifyForm" onsubmit="sysRoleModify();return false;" name="sysRoleModifyForm">
				...
				<div class="movie_list">
					<dl class="movie_fill">
						...
						<dd class="mleft_99">
							<div class="movie_type cinema_feed">
								<input type="text" id="roleName" maxlength="50" name="roleName" placeholder="角色名称" class="validate[required],maxSize[50]" value="${sysRole.roleName}">
							</div>
						</dd>
					</dl>
					...
					<dl class="movie_fill">
						...
						<dd class="mleft_99">
							<div class="movie_type cinema_feed">
								<textarea rows="6" cols="60" class="form_textarea" id="note" name="note" maxlength="200" >${sysRole.note}</textarea>
								<%-- <input type="text" id="note" name="note" maxlength="200" placeholder="备注" value="${sysRole.note}"> --%>
							</div>
						</dd>
					</dl>
					<div class="clearfix"></div>
		...
		<script type="text/javascript">
			...
			function getTreeData(roleid) {
				...
				$.ajax({
					...
					dataType : "json",
					async : false,
					url : '${ctx}/sysMenuFunction/roleTree/' + roleid,
			...
			function count() {
				var zTree = $.fn.zTree.getZTreeObj("menuTree"), changeCount = zTree.getChangeCheckedNodes().length;
				return changeCount;
			}
			//修改角色表
			function sysRoleModify() {
				if($("#sysRoleModifyForm").validationEngine("validate")){
					...
					$.ajax({
						...
						dataType : "json",
						async : false,
						url : '${ctx}/sysRole/modify',
						data : $('#sysRoleModifyForm').serialize(),
						success : function(data) {
							if (data.status != '0') {
								alert(data.error);
								return false;
			...
			$(document).ready(function() {
				...
				$.fn.zTree.init($("#menuTree"), setting, getTreeData(roleid));
			});
			$("#sysRoleModifyForm").validationEngine();
		</script>
	</body>
</html>
